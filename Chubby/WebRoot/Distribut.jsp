...
<body>
		...
		<div class="row">
			<div class="col-md-12" id="personheard">
				...
				<div class="col-md-6"
					...
					<blockquote>
						<p id="heardtitle">
							欢迎您，我们已根据所有同学的PC日志，分析得出了这份开关机时点分布图,在这里你可以看到所有同学的开关机时间点</p>
			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					<dl class="descreption">
						...
						<dd>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;这是根据所有同学每天的开关机时间计算得出的，这里显示了所有同学的开关机时点记录，您还可以根据榜单右上角的按钮保存为图片，
	...
	<div>
		...
		<div class="container">
			...
			<p>
				感谢 <a rel="license" href="http://www.cqjtu.edu.cn" target="_blank">重庆交通大学</a>信息科学与工程学院计科4班所有同学提供的数据，
				本项目的所有实验数据可以在<a rel="license" href="https://" target="_blank">https://</a>
